...
\begin{instructions}{\vtune}
 \begin{center}
  \includegraphics[width=0.7\textwidth]{node-level/vtune-task-size.png}
 \end{center}
 
 \noindent
 In \vtune, tiny tasks often manifest in very high CPU utilisation, while the effective CPU usage (user code) is comparably small.
\end{instructions}
