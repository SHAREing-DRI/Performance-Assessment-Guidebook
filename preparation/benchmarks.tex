...
There has to be one well-defined benchmark. If we are given a set of
    ...
    the risk of comparing different characteristics produced by different code parts.
...
\begin{itemize}
  ...
  \item The benchmark does not run for too long, and it does not terminate too early. ``Good'' runs are often 3--5 minutes, so we get a good coverage of performance characteristics, but we do not wait for ages.
