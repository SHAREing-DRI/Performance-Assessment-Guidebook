...
It is convenient to present the overall data as spiderweb diagram (below for a code that has I/O issues, doesn't scale particularly well between nodes and has no GPU yet reasonably good core performance and node scaling):
...
\begin{itemize}[noitemsep]
  \item[$\boxplus$] Ignore most of things you know about tools to avoid that you are not able to see obvious shortcomings.
...
\begin{itemize}[noitemsep]
  ...
  \item[$\boxminus$] Start to measure without a clear what you want to measure.
\end{itemize}
