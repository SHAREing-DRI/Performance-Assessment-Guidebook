...
When preparing the benchmark for core, intra-node, inter-node and GPU analysis, we advised turning off I/O as this can make some of the measurements unreliable. However, I/O performance is crucial for some codes and so here we advise turning on some example of typical I/O load, which again can be information provided by the code's developers.
