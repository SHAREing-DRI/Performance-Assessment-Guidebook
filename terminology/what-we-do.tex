...
Third, we conduct a \emph{performance analysis} to explain why the code exhibits the observed behavior.
Finally, this analysis feeds into program tuning or optimisation, and we repeat the workflow.



If we take our list of activities and integrate it with the definition of the performance analysis workflow, it becomes clear that the tuning step is out-of-scope here.
...
This might be an ideal in the spirit of eXtreme Programming \cite{xxx}, where
...
Developers inevitably make assumptions about reasons for code behavior when working on performance analysis.
