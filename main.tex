...
\input{terminology/development-workflow}
\input{terminology/hpc-terms}
\input{terminology/bottom-up}
\input{terminology/symptoms}

\part{High Level Overview}
\label{part:high-level}
...
\input{preparation/code-scaling}
\input{preparation/io}
\input{preparation/wrap-up}
...
\input{high-level/wrap-up}

\part{Tailor to the machine}
\label{part:tailor}
\input{tailoring/tailoring}
\input{tailoring/core}
\input{tailoring/gpu}
\input{tailoring/io}
\input{tailoring/intra-node}
\input{tailoring/inter-node}
\input{tailoring/wrap-up}

\part{Deep Dive}
\label{part:performance-assessment}

\input{workflow/workflow}
\input{workflow/localisation}
\input{workflow/navigation}

\input{core/core}
\input{core/hardware-counters}
\input{core/vectorisation}
%\input{core/compiler-optimisations}
%\input{core/overhead}
...
\input{node-level/tasks-too-small}
\input{node-level/loops-too-small}
\input{node-level/tasks-too-big}
\input{node-level/numa}
\input{node-level/synchronisation}
\input{node-level/dependencies}
\input{node-level/redundant-admin}
\input{node-level/homogeneous-duration}
...
%
% It is also a crime if people use only a fraction of hte main memory. This happened
% apparently when the NR guys were thrown onto Cosma, where they had so much RAM.
%
%
...
\input{case-studies/case-studies-intro}
...
\input{appendix/submission-checklist}
\input{appendix/metric-choice}
\input{appendix/communication}
